...
select
    ...
    office_exists, village, parish, sub_county, county, district, region,
    number_of_beneficiaries, total_funds_received, total_funds_disbursed,
    total_repayments, is_active, created_at, updated_at
