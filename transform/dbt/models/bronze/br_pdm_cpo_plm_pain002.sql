...
with raw_data as (
    ...
    select
        ...
        {{ extract_json('parsed_event_data', '$.xml.TechnicalPaymentEvent.XAgentReference') }} as raw_xml_technical_xagent_reference,
        {{ extract_json('parsed_event_data', '$.xml.TechnicalPaymentEvent.XBeneficiarySa') }} as raw_xml_technical_xbeneficiary_sa,
        {{ extract_json('parsed_event_data', '$.xml.TechnicalPaymentEvent.XCashoutStatus') }} as raw_xml_technical_xcashout_status,
        ...
        {{ extract_json('parsed_event_data', '$.xml.TechnicalPaymentEvent.XCreditStatus') }} as raw_xml_technical_xcredit_status,
        ...
        {{ extract_json('parsed_event_data', '$.xml.TechnicalPaymentEvent.XNetwork') }} as raw_xml_technical_xnetwork,
        ...
        {{ extract_json('parsed_event_data', '$.xml.TechnicalPaymentEvent.XProvider') }} as raw_xml_technical_xprovider,
        {{ extract_json('parsed_event_data', '$.xml.TechnicalPaymentEvent.XProviderTransactionId') }} as raw_xml_technical_xprovider_transaction_id,
        ...
        {{ extract_json('parsed_event_data', '$.xml.TechnicalPaymentEvent.XWalletReference') }} as raw_xml_technical_xwallet_reference,
...
select
    ...
    raw_event_family, raw_event_id, raw_source_system, raw_xml_technical_business_reference, raw_xml_technical_correlation_id, raw_xml_technical_end_to_end_id, raw_xml_technical_event_family, raw_xml_technical_event_id, raw_xml_technical_event_timestamp, raw_xml_technical_event_type, raw_xml_technical_message_id, raw_xml_technical_payment_instruction_id, raw_xml_technical_processing_timestamp, raw_xml_technical_technical_stage, raw_xml_technical_technical_status, raw_xml_technical_transaction_id, raw_xml_technical_uetr, raw_xml_technical_xagent_reference, raw_xml_technical_xbeneficiary_sa, raw_xml_technical_xcashout_status, raw_xml_technical_xchannel, raw_xml_technical_xcomponent, raw_xml_technical_xcredit_status, raw_xml_technical_xerror_category, raw_xml_technical_xerror_code, raw_xml_technical_xhost, raw_xml_technical_xlatency_ms, raw_xml_technical_xnetwork, raw_xml_technical_xnode, raw_xml_technical_xoperation, raw_xml_technical_xprovider, raw_xml_technical_xprovider_transaction_id, raw_xml_technical_xretry_count, raw_xml_technical_xservice, raw_xml_technical_xsource_system, raw_xml_technical_xtarget_system, raw_xml_technical_xtimeout_indicator, raw_xml_technical_xtrace, raw_xml_technical_xwallet_reference
